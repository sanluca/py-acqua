...
static PyObject *
_wrap_egg_tray_icon_new_for_screen(PyObject *self, PyObject *args, PyObject *kwargs)
{
    static char *kwlist[] = { "screen", "name", NULL };
    PyGObject *screen;
    char *name;
    EggTrayIcon *ret;

    if (!PyArg_ParseTupleAndKeywords(args, kwargs, "O!s:egg_tray_icon_new_for_screen", kwlist, &PyGdkScreen_Type, &screen, &name))
        return NULL;
    ret = egg_tray_icon_new_for_screen(GDK_SCREEN(screen->obj), name);
    /* pygobject_new handles NULL checking */
    return pygobject_new((GObject *)ret);
}

PyMethodDef pytrayicon_functions[] = {
    { "egg_tray_icon_new_for_screen", (PyCFunction)_wrap_egg_tray_icon_new_for_screen, METH_VARARGS|METH_KEYWORDS },
    { NULL, NULL, 0 }
};
